...
ARG GMAIL_USER_EMAIL=${GMAIL_USER_EMAIL}
ARG GMAIL_PASSWORD=${GMAIL_PASSWORD}
ARG GMAIL_APP_PASSWORD=${GMAIL_APP_PASSWORD}
ARG RECAPTCHA_PUBLIC_KEY=${RECAPTCHA_PUBLIC_KEY}
ARG RECAPTCHA_PRIVATE_KEY=${RECAPTCHA_PRIVATE_KEY}
ARG MAIL_SERVER=${MAIL_SERVER}
ARG MAIL_PORT=${MAIL_PORT}
ARG MAIL_USE_TLS=${MAIL_USE_TLS}
ARG MAIL_USERNAME=${MAIL_USERNAME}
ARG MS_TRANSLATOR_KEY=${MS_TRANSLATOR_KEY}
ARG MS_BLOB_CONNECTION_STRING=${MS_BLOB_CONNECTION_STRING}
ARG MS_BLOB_CONTAINER_NAME=${MS_BLOB_CONTAINER_NAME}
